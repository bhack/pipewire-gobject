...
char *
pwg_client_info_dup_client_id(PwgClientInfo *self)
{
  g_return_val_if_fail(PWG_IS_CLIENT_INFO(self), NULL);

  return pwg_global_dup_property(self->global, PW_KEY_CLIENT_ID);
}
...
char *
pwg_client_info_dup_application_name(PwgClientInfo *self)
{
  g_return_val_if_fail(PWG_IS_CLIENT_INFO(self), NULL);
